...
import 'package:intro_to_app/home_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: IntroductionScreen(
        ...
        pages: [
          ...
          PageViewModel(
            ...
            decoration: pageDecoration,
              ...
              decoration: pageDecoration,
              footer: Padding(padding: EdgeInsets.only(top: 50 , left: 15 , right: 15),
        ...
        back: Text("Back",style: TextStyle(fontWeight: FontWeight.w600 , color: Colors.redAccent),),
        skip: Text("Skip",style: TextStyle(fontWeight: FontWeight.w600 , color: Colors.redAccent),),
